            ...
            <div>
                ...
                <section class="scroll-section" id="images">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-lg-4 col-xl-3 col-xxl-2 col-12">
                            <div class="card mb-5">
                                <img src="img/product/small/product-3.webp" class="card-img-top"
                                    alt="card image">
                                <div class="card-body">
                                    <h5 class="card-title">Card Title</h5>
                                    <p class="card-text">
                                        Snaps muffin macaroon tiramisu ice cream toffee carrot sesame
                                        tootsie roll.Brownie ice cream marshmallow topping.
                                    </p>
                        ...
                        <div class="col-md-4 col-sm-6 col-lg-4 col-xl-3 col-xxl-2 col-12">
                            <div class="card mb-5">
                                ...
                                <img src="img/product/small/product-10.webp" class="card-img-bottom"
                                    alt="card image">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-8 col-lg-6 col-xl-4 col-xxl-3 col-12">
                            <div class="card mb-5 bg-dark">
                                <img src="img/product/small/product-2.webp" class="card-img"
                                    alt="card image">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        cookie jelly-o tootsie roll chocolate bar. Jujubes candy jelly-o
                                        topping lemon drops.
                                    </p>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="card-body d-flex flex-column h-100">
                                            ...
                                            <p class="card-text mb-1 d-flex">
                                                Icing liquorice oat cake caramels. Sugar plum gummi bears
                                                jujubes tootsie roll chocolate bar. Jujubes candy jelly-o
                                                topping.
                                            </p>
                            ...
                            <div class="card mb-5">
                                <div class="row g-0 sh-13">
                                    <div class="col-2 col-sm-3 h-100">
                                        <img src="img/product/small/product-10.webp" alt="alternate text"
                                            class="card-img card-img-horizontal">
                                    </div>
                                    <div class="col-10 col-sm-9">
                                        <div class="card-body d-flex flex-column">
                                            <p class="heading mb-1">Cream Toffee</p>
                                            <p class="text-muted m-0 text-small">Rua Olegário Ferreira 1081,
                    ...
                    <div class="card mb-5">
                        <div class="row g-0 sh-10">
                            <div class="col-2 col-lg-1 d-flex align-items-center h-100">
                                <img src="img/product/small/product-8.webp" alt="card image"
                                    class="card-img card-img-horizontal">
                            </div>
                    ...
                    <div class="card mb-5">
                        <div class="row g-0 sh-lg-8 h-auto p-card pt-lg-0 pb-lg-0">
                            ...
                            <div class="col-2 h-100 d-flex align-items-center justify-content-end">
                                <button class="btn btn-sm btn-icon btn-icon-only btn-outline-light"
                                    type="button">
                        ...
                        <div class="col-sm-6 col-xxl-3">
                            <div class="card sh-19">
                                <div
                                    ...
                                    <i data-acorn-icon="pepper" class="text-primary mb-3"></i>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 g-4">
                            <div class="col">
                                <div class="card h-100">
                                    <img src="img/product/small/product-2.webp" class="card-img-top"
                                        alt="image">
                                    <div class="card-body">
                                        <h5 class="card-title">Card title</h5>
                                        <p class="card-text">
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <img src="img/product/small/product-7.webp" class="card-img-top"
                                        alt="image">
                                    <div class="card-body">
                                        <h5 class="card-title">Card title</h5>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <img src="img/product/small/product-5.webp" class="card-img-top"
                                        alt="image">
                                    <div class="card-body">
                                        <h5 class="card-title">Card title</h5>
                                        <p class="card-text">
                ...
                <section class="scroll-section" id="masonryCards">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 g-4" id="masonryCardsExample">
                        <div class="col">
                            <div class="card">
                                <img src="img/product/small/product-2.webp" class="card-img-top sh-30"
                                    alt="image">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="img/product/small/product-3.webp" class="card-img-top sh-15"
                                    alt="image">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="img/product/small/product-7.webp" class="card-img-top sh-30"
                                    alt="image">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="img/product/small/product-5.webp" class="card-img-top sh-20"
                                    alt="image">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="img/product/small/product-6.webp" class="card-img-top sh-20"
                                    alt="image">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="img/product/small/product-1.webp" class="card-img-top sh-15"
                                    alt="image">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="img/product/small/product-10.webp" class="card-img-top sh-15"
                                    alt="image">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">This is a longer card with supporting text below as
