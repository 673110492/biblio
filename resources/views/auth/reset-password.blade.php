...
<!-- Mirrored from acorn-html-classic-dashboard.coloredstrategies.com/Pages.Authentication.ResetPassword.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2022 12:28:21 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="col-12 col-lg-auto h-100 pb-4 px-4 pt-0 p-lg-0">
                    <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
                        <div class="sw-lg-50 px-5">
                            ...
                            <div>
                                <form method="POST" action="{{ route('password.store') }}"  id="resetForm" class="tooltip-end-bottom" novalidate>
                                    @csrf
