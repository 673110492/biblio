        ...
        <div class="page-title-container">
            <div class="row">
                <div class="col-12 col-md-7">
                    <h1 class="mb-0 pb-0 display-4" id="title">FORMULAIRE D'AJOUT DU NIVEAU SCOLAIRE </h1>
                </div>
            </div>
            @if($errors->any())
            ...
            <div class="card mb-5">
                <div class="card-body">
                    <form method="POST" action="{{ url('niveau') }}" id="validationTopLabel" class="tooltip-end-top" novalidate="novalidate">
                        @csrf
